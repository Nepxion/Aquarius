...
import com.nepxion.aquarius.idgenerator.redis.configuration.RedisIdGeneratorConfiguration;

@Configuration
@Import({ AquariusConfiguration.class, RedisIdGeneratorConfiguration.class })
